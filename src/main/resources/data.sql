...
INSERT INTO tasks(person_id, title, is_completed, content, important, due_date, created_date ) VALUES(2, 'ヨガする',  false, 'テスト用のタスクです', 1, '2023-05-25', '2023-05-19');
...
INSERT INTO tasks(person_id, title, is_completed, content, important, due_date, created_date ) VALUES(1, '夕飯を作る',  false, 'テスト用のタスクです', 3, '2023-05-29', '2023-05-20');
...
INSERT INTO tasks(person_id, title, is_completed, content, important, due_date, created_date ) VALUES(1, '車の掃除をする',  false, 'テスト用のタスクです', 0, '2023-05-31', '2023-05-22');
