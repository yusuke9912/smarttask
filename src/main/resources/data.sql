...
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(2, 4, '報告書を書く', false, 'プロジェクトの進捗をまとめる', 3, '2023-05-26 00:00:00', '2023-05-15 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(3, 1, '友達とランチする', false, '新しいカフェでランチ', 1, '2023-05-27 00:00:00', '2023-05-16 12:00:00');
...
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(1, 1, 'プランを立てる', false, '来週の旅行のプランを考える', 2, '2023-06-04 00:00:00', '2023-05-25 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(2, 5, '家具を買う', false, '新しいソファを購入', 4, '2023-05-29 00:00:00', '2023-05-26 16:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(3, 4, 'スポーツ観戦する', false, '試合チケットを予約', 1, '2023-05-31 00:00:00', '2023-05-27 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(1, 2, '家具の配置を変える', false, 'リビングの模様替え', 5, '2023-06-01 00:00:00', '2023-05-28 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(2, 1, '映画を観る', false, '最新作を映画館で鑑賞', 3, '2023-06-02 00:00:00', '2023-05-29 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(3, 3, '友達と遊ぶ', false, 'カフェでおしゃべり', 2, '2023-05-30 00:00:00', '2023-05-30 12:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(1, 4, 'プロジェクトミーティング', false, '進捗報告と次回の計画立案', 4, '2023-06-03 00:00:00', '2023-05-31 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(2, 2, '家族とディナー', false, 'お気に入りのレストランで食事', 1, '2023-06-04 00:00:00', '2023-06-01 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(3, 5, '趣味の習い事', false, '新しい曲の練習', 2, '2023-06-01 00:00:00', '2023-06-02 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(1, 3, '美容院に行く', false, 'カットとカラーリング', 3, '2023-06-02 00:00:00', '2023-06-03 00:00:00');
INSERT INTO tasks(person_id, tag_id, title, is_completed, content, important, due_datetime, created_datetime ) VALUES(2, 4, 'プレゼントを購入', false, '友人の誕生日プレゼント', 5, '2023-06-03 00:00:00', '2023-06-04 00:00:00');
